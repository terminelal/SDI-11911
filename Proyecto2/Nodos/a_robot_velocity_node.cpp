...
//Funcion empleada para transformar las velocidades (x,y,w) en
//velocidades aplicadas al los motores (m1, m2, r1).
...
int main(int argc, char **argv){
	...
	//Nos subscribimos al servicio de Gazebo, ApplyJointEffort.
	...
	effort [2] = velMots[1];	
		...
		if(client.exists()){
			...
			//Enlazamos los Joints con los esfuerzos calculados.
